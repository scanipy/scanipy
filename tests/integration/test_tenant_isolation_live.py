...
credentials via the OIDC deploy role, account 123456789012). The dated run URL
...
- The worker task role (default arn:aws:iam::123456789012:role/scanipy-ecs-worker,
