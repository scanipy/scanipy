...
CMK_A = "arn:aws:kms:us-east-1:123456789012:key/9d8c7b6a-5f4e-4d3c-b2a1-0f9e8d7c6b5a"
...
def test_malformed_cmk_arn_is_rejected() -> None:
    with pytest.raises(TenantCmkArnFormatError):
        render_worker_session_policy(ORG_A, "arn:aws:kms:us-east-1:123456789012:alias/x")
