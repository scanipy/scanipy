...
class SessionService:
    def restore(self, renamed0):
        ...
        renamed2 = 0
        length = len(renamed0)
        renamed3 = _extracted_value(renamed0, renamed1, length, renamed2)
        data = pickle.loads(renamed3)
        return data


def _extracted_value(renamed0, renamed1, length, renamed2):
    return renamed0[renamed1:length - renamed2]
