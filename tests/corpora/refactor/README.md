...
seeds from public repositories is deferred to v1.0.0 — see **CLAR-CORP-04** in
...
| Distinct (class, language) topologies | 8 | target set by CLAR-CORP-04 |
...
- `WBS.md §17 CLAR-CORP-04` — topology-diversity expansion (v0.1.0 → v1.0.0).
