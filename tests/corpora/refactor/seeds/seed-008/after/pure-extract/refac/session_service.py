...
class SessionService:
    def restore(self, input007):
        ...
        right007 = 0
        length = len(input007)
        value007 = _extracted_value(input007, left007, length, right007)
        data = pickle.loads(value007)
        return data


def _extracted_value(input007, left007, length, right007):
    return input007[left007:length - right007]
